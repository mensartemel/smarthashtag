  ...
  if ($errorCount <= 0) {
    ...
    if ($errorCount > 0) {
      ...
      while ($row = $stmt->fetch()) {
        ...
        echo "<label class='cbcontainer'>Relevant<input type='checkbox' id='".$row['resultid']."' class='cb' name='rate' value='like-".$row['shid']."'><span class='checkmark'></span></label>";
        echo "<label class='cbcontainer'>Irrelevant<input type='checkbox' id='".$row['resultid']."' class='cb' name='rate' value='dislike-".$row['shid']."'><span class='checkmark'></span></label>";
        echo "</div>";
        $count += 1;
      }
      echo "</form>";
